...
import Style from './Juntos.module.scss'
        ...
        <div className="container">
          ...
          {!saibaMais && (
            <section className={Style.filmeSaibaMais}>
              ...
              <Slide.Title className={Style.slideTitle}>Regulamento</Slide.Title>
              <section className={Style.areaRegulamento}>
                ...
                <div>
                  <h2>
                    Promoção: Compre 1 ingresso e leve 2 ingressos para o filme
                    Juntos
                  </h2>
                  <p>
                    ...
                    www.diamondfilms.com.br, e não se aplica a compras realizadas
                    em cinemas.
                  </p>
                  <p>
